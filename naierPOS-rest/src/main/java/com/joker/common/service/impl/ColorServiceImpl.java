...
public class ColorServiceImpl implements ColorService {
	 ...
	 */
	@Override
	public Page<Color> getColorPageByClient(String clientId, int start, int limit) {
		Page<Color> page = new Page<Color>();
		int totalRecord = mapper.getColorCountByClient(clientId);
		List<Color> list = mapper.getColorByClient(clientId, start, limit);
